...
public class Flk10010003 extends CommonFlk {
    @Getter
    private static final String code = "10010003";
    @Getter private static final String message = "Возможность блокировки администраторов отключена";
